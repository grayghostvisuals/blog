...
*/
function my_admin_footer() {
echo 'Built by <a href="'. get_bloginfo('siteurl') .'">'. get_bloginfo()  .'</a> with <a href="http://wordpress.org">WordPress</a>. &bull; <a href="' . admin_url('freedoms.php') . '">Freedoms</a> &bull; <a href="' . admin_url('credits.php') . '">Credits</a>';
}
